      ...
      <div class="heading">
        <v-list-item-group>
          <div class="allTasks tasksButtons">
            <v-list-item v-on:click="setTaskTab('all-tasks')" active-class="activeTaskTabList" dark>
              <v-list-item-action>
          ...
          <div class="myTasks tasksButtons">
            <v-list-item v-on:click="setTaskTab('my-tasks')" active-class="activeTaskTabList" dark>
              <v-list-item-action>
                <v-icon size="20" color>icon-task</v-icon>
              </v-list-item-action>
              <v-list-item-content class="buttonText">
          ...
          <div class="createTask tasksButtons">
            <v-list-item v-on:click="setTaskTab('add-task')" active-class="activeTaskTabList" dark>
              <v-list-item-action>
                <v-icon size="20" color>icon-task</v-icon>
              </v-list-item-action>
              <v-list-item-content class="buttonText">
