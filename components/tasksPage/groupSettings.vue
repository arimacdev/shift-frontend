<template>
  <div class="groupSettingsContent">
    <v-list-item>
      <v-list-item-content>
        <v-text-field flat solo background-color="#EDF0F5" v-model="taskGroupName"></v-text-field>
      </v-list-item-content>
      <v-list-item-action>
        <v-btn
          width="250px"
    ...
    <v-list-item>
      ...
      <v-dialog v-model="settingsDialog" max-width="380">
        <v-card>
          <div class="popupConfirmHeadline">
            ...
            >You're about to permanantly delete this group and all of its data. If you're not sure, you can cancel this action.</span>
          </div>
