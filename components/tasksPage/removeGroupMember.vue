  ...
  <v-row justify="center">
    <v-dialog v-model="dialog" persistent max-width="390">
      ...
      <v-card >
        ...
        <v-icon class="deleteMemberPopupIcon" size="60" color="deep-orange lighten-1">mdi-alert-outline</v-icon>
        <v-card-text class="deletePopupTitle">Remove Member</v-card-text>
        <v-card-text>You are about to remove member from group. <span>If you are not sure, you can close this popup</span></v-card-text>
